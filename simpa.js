...
var OptionPane = /** @class */ (function () {
    ...
    if (input) {
      ...
      if (input.tagName === "INPUT" && input.getAttribute("type") === "text") {
        input.onkeydown = function (ev) {
          ...
          if (ev.key === "Enter") {
            ev.preventDefault();
            (_a = _this.dialogOkButton) === null || _a === void 0
              ? void 0
              : _a.click();
          }
        };
  ...
  Object.defineProperty(OptionPane, "optionPaneModalLayer", {
    get: function () {
      if (!OptionPane._optionPaneModalLayer) {
        var modalLayer = document.body.querySelector(
  ...
  OptionPane.createErrorIcon = function () {
    var errorIcon = document.createElementNS(
  ...
  OptionPane.createInformationIcon = function () {
    var informationIcon = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "svg"
    );
  ...
  OptionPane.createWarningIcon = function () {
    var warningIcon = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "svg"
    );
  ...
  OptionPane.createQuestionIcon = function () {
    var questionIcon = document.createElementNS(
      "http://www.w3.org/2000/svg",
      "svg"
    );
    ...
    if (icon) {
      return new Promise(function (resolve, reject) {
        ...
        img.onload = function () {
          ...
          (_a = optionPane.dialogOkButton) === null || _a === void 0
            ? void 0
            : _a.focus();
        };
  ...
  OptionPane.showConfirmDialog = function (
    message,
    title,
    optionType,
    messageType,
    ...
    if (optionType === void 0) {
      optionType = "yes-no-cancel";
    }
    OptionPane.optionPaneModalLayer.style.visibility = "inherit";
    if (icon) {
      return new Promise(function (resolve, reject) {
        ...
        img.onload = function () {
          ...
          if (optionPane.dialogOkButton) {
            ...
            (_a = optionPane.dialogYesButton) === null || _a === void 0
              ? void 0
              : _a.focus();
          }
        };
  ...
  OptionPane.showInputDialog = function (
    message,
    title,
    messageType,
    icon,
  ...
  OptionPane.showOptionDialog = function (
    message,
    title,
    optionType,
    messageType,
...
var TabContainer = /** @class */ (function () {
  ...
  TabContainer.setSelectedTabComponent = function (
    tabContainer,
    cardContainer,
