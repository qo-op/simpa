...
class OptionPane {
    ...
    static showMessageDialog = (message: string = "", title: string = "Message", messageType: string = "information", icon?: string) => {
        return new Promise((resolve, reject) => {
            ...
            const dialog = OptionPane.createDialog(resolve, message, title, messageType, icon);
            modalLayer.appendChild(dialog);
            modalLayer.style.visibility = "inherit";
        });
    }

    static createDialog(resolve: (input: string) => void, message: string, title: string, messageType: string, icon?: string) {
        ...
        const dialogOkButton = OptionPane.createDialogOkButton();
        dialogButtonPane.appendChild(dialogOkButton);

        dialogOkButton.onclick = function (ev: MouseEvent) {
